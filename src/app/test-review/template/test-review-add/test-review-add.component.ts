...
@Component({
  selector: 'app-test-review-add',
  templateUrl: './test-review-add.component.html',
  styleUrls: ['./test-review-add.component.css']
})
export class TestReviewAddComponent implements OnInit {
  currency_stack:any;
  productType:any;
  currency=[]
  data:any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TestReviewAddComponent>,
