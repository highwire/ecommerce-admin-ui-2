...
@Component({
  selector: 'app-test-review-delete',
  templateUrl: './test-review-delete.component.html',
  styleUrls: ['./test-review-delete.component.css']
})
export class TestReviewDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TestReviewDeleteComponent>,
