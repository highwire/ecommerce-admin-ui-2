...
@Component({
  selector: 'app-test-review-edit',
  templateUrl: './test-review-edit.component.html',
  styleUrls: ['./test-review-edit.component.css']
})
export class TestReviewEditComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    ...
    public dialogRef: MatDialogRef<TestReviewEditComponent>,
    ) { }
