...
@Component({
  selector: 'app-test-review-add-new-price',
  templateUrl: './test-review-add-new-price.component.html',
  styleUrls: ['./test-review-add-new-price.component.css']
})
export class TestReviewAddNewPriceComponent implements OnInit {
  entry:any;
  currency:any=[];
  sitedata:any;
  pricedata:any= [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TestReviewAddNewPriceComponent>,
