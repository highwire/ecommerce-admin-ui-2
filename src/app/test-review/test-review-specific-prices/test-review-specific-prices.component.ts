...
import { TestReviewModule } from '../test-review.module';
...
@Component({
  selector: 'app-test-review-specific-prices',
  templateUrl: './test-review-specific-prices.component.html',
  styleUrls: ['./test-review-specific-prices.component.css']
})
export class TestReviewSpecificPricesComponent implements OnInit {
  ...
  data.forEach((element:any) => {
    // console.log(element);
    if(element.prices && Array.isArray(element.prices)  && (element.productType=='test-review'  || element.productType=='test-review' )){
      // debugger
  ...
  delete(element:any){
    ...
    const dialogRef = this.dialog.open(TestReviewDeleteComponent, {
      width: '950px',
      height: '500px',
      data: {element},
    });
  ...
  viewAdd(element:any){
    ...
    const dialogRef = this.dialog.open(TestReviewAddComponent, {
      width: '1050px',
      height: '600px',
  ...
  addData(){
    ...
    const dialogRef = this.dialog.open(TestReviewAddNewPriceComponent, {
      width: '950px',
      height: '400px',
      data: {
        prices:p},
  ...
  edit(element:any){
    // console.log(element);
    var p= this.getCurrentPrices(element)
    const dialogRef = this.dialog.open(TestReviewEditComponent, {
      width: '950px',
      height: '500px',
      data: {element,
        prices:p},
