...
@Component({
  selector: 'app-new-add-journal-subscription',
  templateUrl: './new-add-journal-subscription.component.html',
  styleUrls: ['./new-add-journal-subscription.component.css']
})
export class NewAddJournalSubscriptionComponent implements OnInit {
  selectedJournal:any;
  dropdownList :any= [];
  selected:any=  false;
  selectedItems :any= [];
...
sitedata:any;
  ...
  constructor(
    ...
    public hwv: hwValidator,
        public dialogRef: MatDialogRef<NewAddJournalSubscriptionComponent>,
  ) { 
  }
