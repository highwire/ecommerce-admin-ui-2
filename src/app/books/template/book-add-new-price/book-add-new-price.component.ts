...
@Component({
  selector: 'app-book-add-new-price',
  templateUrl: './book-add-new-price.component.html',
  styleUrls: ['./book-add-new-price.component.css']
})
export class BookAddNewPriceComponent implements OnInit {
  entry:any;
  currency:any=[];
  sitedata:any;
  pricedata:any= [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<BookAddNewPriceComponent>,
