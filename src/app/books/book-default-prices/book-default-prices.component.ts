...
@Component({
  selector: 'app-book-default-prices',
  templateUrl: './book-default-prices.component.html',
  styleUrls: ['./book-default-prices.component.css']
})
export class BookDefaultPricesComponent implements OnInit {
  dropdownList :any= [];
  selected:any=  false;
  selectedItems :any= [];
