...
import { ReportGuidelineModule } from '../report-guideline.module';
...
@Component({
  selector: 'app-monograph-specific-prices',
  templateUrl: './report-guideline-specific-prices.component.html',
  styleUrls: ['./report-guideline-specific-prices.component.css']
})
export class ReportGuidelineSpecificPricesComponent implements OnInit {
  ...
  delete(element:any){
    ...
    const dialogRef = this.dialog.open(ReportGuidelineDeleteComponent, {
      width: '950px',
      height: '500px',
      data: {element},
    });
  ...
  viewAdd(element:any){
    ...
    const dialogRef = this.dialog.open(ReportGuidelineAddComponent, {
      width: '1050px',
      height: '600px',
  ...
  addData(){
    ...
    const dialogRef = this.dialog.open(ReportGuidelineAddNewPriceComponent, {
      width: '950px',
      height: '400px',
      data: {
        prices:p},
  ...
  edit(element:any){
    // console.log(element);
    var p= this.getCurrentPrices(element)
    const dialogRef = this.dialog.open(ReportGuidelineEditComponent, {
      width: '950px',
      height: '500px',
      data: {element,
        prices:p},
