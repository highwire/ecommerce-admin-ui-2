...
@Component({
  selector: 'app-report-guideline-delete',
  templateUrl: './report-guideline-delete.component.html',
  styleUrls: ['./report-guideline-delete.component.css']
})
export class ReportGuidelineDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReportGuidelineDeleteComponent>,
