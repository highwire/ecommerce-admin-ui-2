...
@Component({
  selector: 'app-report-guideline-add',
  templateUrl: './report-guideline-add.component.html',
  styleUrls: ['./report-guideline-add.component.css']
})
export class ReportGuidelineAddComponent implements OnInit {
  currency_stack:any;
  productType:any;
  currency=[]
  data:any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReportGuidelineAddComponent>,
