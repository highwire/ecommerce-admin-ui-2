...
@Component({
  selector: 'app-report-guideline-add-new-price',
  templateUrl: './report-guideline-add-new-price.component.html',
  styleUrls: ['./report-guideline-add-new-price.component.css']
})
export class ReportGuidelineAddNewPriceComponent implements OnInit {
  entry:any;
  currency:any=[];
  sitedata:any;
  pricedata:any= [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReportGuidelineAddNewPriceComponent>,
