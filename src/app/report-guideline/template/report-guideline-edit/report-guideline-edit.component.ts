...
@Component({
  selector: 'app-report-guideline-edit',
  templateUrl: './report-guideline-edit.component.html',
  styleUrls: ['./report-guideline-edit.component.css']
})
export class ReportGuidelineEditComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    ...
    public dialogRef: MatDialogRef<ReportGuidelineEditComponent>,
    ) { }
