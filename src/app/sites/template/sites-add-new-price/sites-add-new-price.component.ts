...
@Component({
  selector: 'app-sites-add-new-price',
  templateUrl: './sites-add-new-price.component.html',
  styleUrls: ['./sites-add-new-price.component.css']
})
export class SitesAddNewPriceComponent implements OnInit {
  entry:any;
  currency:any=[];
  sitedata:any;
  pricedata:any= [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SitesAddNewPriceComponent>,
