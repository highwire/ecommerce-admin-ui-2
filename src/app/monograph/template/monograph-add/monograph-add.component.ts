...
@Component({
  selector: 'app-monograph-add',
  templateUrl: './monograph-add.component.html',
  styleUrls: ['./monograph-add.component.css']
})
export class MonographAddComponent implements OnInit {
  currency_stack:any;
  productType:any;
  currency=[]
  data:any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MonographAddComponent>,
