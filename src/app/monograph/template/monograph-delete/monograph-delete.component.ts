...
@Component({
  selector: 'app-monograph-delete',
  templateUrl: './monograph-delete.component.html',
  styleUrls: ['./monograph-delete.component.css']
})
export class MonographDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MonographDeleteComponent>,
