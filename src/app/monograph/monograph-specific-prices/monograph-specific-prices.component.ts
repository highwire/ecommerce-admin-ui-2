...
import { MonographModule } from '../monograph.module';
...
@Component({
  ...
  templateUrl: './monograph-specific-prices.component.html',
  styleUrls: ['./monograph-specific-prices.component.css']
})
export class MonographSpecificPricesComponent implements OnInit {
  ...
  delete(element:any){
    ...
    const dialogRef = this.dialog.open(MonographDeleteComponent, {
      width: '950px',
      height: '500px',
      data: {element},
    });
  ...
  viewAdd(element:any){
    ...
    const dialogRef = this.dialog.open(MonographAddComponent, {
      width: '1050px',
      height: '600px',
  ...
  addData(){
    ...
    const dialogRef = this.dialog.open(MonographAddNewPriceComponent, {
      width: '950px',
      height: '400px',
      data: {
        prices:p},
  ...
  edit(element:any){
    // console.log(element);
    var p= this.getCurrentPrices(element)
    const dialogRef = this.dialog.open(MonographEditComponent, {
      width: '950px',
      height: '500px',
      data: {element,
        prices:p},
