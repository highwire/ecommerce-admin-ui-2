...
@Component({
  selector: 'app-references-delete',
  templateUrl: './references-delete.component.html',
  styleUrls: ['./references-delete.component.css']
})
export class ReferencesDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReferencesDeleteComponent>,
