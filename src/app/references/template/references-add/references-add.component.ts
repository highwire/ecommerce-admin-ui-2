...
@Component({
  selector: 'app-references-add',
  templateUrl: './references-add.component.html',
  styleUrls: ['./references-add.component.css']
})
export class ReferencesAddComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReferencesAddComponent>,
