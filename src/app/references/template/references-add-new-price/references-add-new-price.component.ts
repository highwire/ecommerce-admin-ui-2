...
@Component({
  selector: 'app-references-add-new-price',
  templateUrl: './references-add-new-price.component.html',
  styleUrls: ['./references-add-new-price.component.css']
})
export class ReferencesAddNewPriceComponent implements OnInit {
  entry:any;
  currency:any=[];
  sitedata:any;
  pricedata:any= [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReferencesAddNewPriceComponent>,
